            ...
            {labourListings.map((labour, index) => (
              <div key={index} className="bg-gray-800 shadow-lg rounded-lg flex flex-col md:flex-row overflow-hidden w-full">
                <div className="w-full md:w-1/3 p-2">
                  <img src={`/images/${labour.profilePhoto}`} alt="Labour" className="w-full h-40 object-cover rounded-lg"/>
                </div>
                <div className="w-full md:w-2/3 p-4 flex flex-col justify-between">
                  ...
                  <div className="flex justify-between mt-4">
                    <button className="bg-green-600 text-white px-3 py-1 rounded">Hire</button>
